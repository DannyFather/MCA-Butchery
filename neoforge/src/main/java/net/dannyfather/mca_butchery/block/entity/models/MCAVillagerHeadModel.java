package net.dannyfather.mca_butchery.block.entity.models;// Made with Blockbench 5.2.0
...
public class MCAVillagerHeadModel<T extends Entity> extends EntityModel<T> {
	// This layer location should be baked with EntityRendererProvider.Context in the entity renderer and passed into this model's constructor
	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(ResourceLocation.fromNamespaceAndPath(MCAButchery.MOD_ID, "villager_head"), "main");
	private final ModelPart Waist;
	private final ModelPart Head;

	public MCAVillagerHeadModel(ModelPart root) {
	...
	public static LayerDefinition createBodyLayer() {
		...
		.texOffs(32, 0).addBox(-4.0F, -8.0F, -4.0F, 8.0F, 8.0F, 8.0F, new CubeDeformation(0.5F)), PartPose.offset(-0.6F, 8.0F, -5.75F));
